...
git clone https://github.com/hyperpolymath/polysafe-gitfixer.git cd
polysafe-gitfixer
...
toolbox create polysafe-gitfixer-dev toolbox enter polysafe-gitfixer-dev
...
polysafe-gitfixer/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
