...
# Contributing — polysafe-gitfixer

## Audience

Developers working **on** `polysafe-gitfixer`. For consumers (people
...
``` bash
git clone git@github.com:hyperpolymath/polysafe-gitfixer.git
...
- Bugs in `polysafe-gitfixer`: file at
  `hyperpolymath/polysafe-gitfixer/issues`.
