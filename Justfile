...
doctor:
    @echo "Running diagnostics for polysafe-gitfixer..."
...
help-me:
    @echo "=== polysafe-gitfixer Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/polysafe-gitfixer/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: polysafe-gitfixer"
