...
// Replace polysafe-gitfixer, Polysafe Gitfixer — See README.adoc for details., just run, Polysafe Gitfixer started successfully. with actuals
= polysafe-gitfixer — Quick Start for Users
:toc:
:toclevels: 2

== What is polysafe-gitfixer?

Polysafe Gitfixer — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./polysafe-gitfixer-portable
----
...
[source]
----
Polysafe Gitfixer started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/polysafe-gitfixer/wiki
